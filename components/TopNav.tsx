  ...
  />
      ...
      <div className="hidden md:block">
        <div className="flex flex-row justify-between items-center w-full bg-[#E2DDDC] border border-[#d8d4d1] rounded-lg pl-5 mt-5 pr-1 py-1 space-x-5">
          <Link href={'/'} className="cursor-pointer text-sm  hover:text-black text-[#333333]">Home</Link>
          <Link href={'/products'} className="cursor-pointer text-sm hover:text-black text-[#333333]">Product</Link>
          <Link href={'/faq'} className="cursor-pointer text-sm hover:text-black text-[#333333]">FAQ</Link>
          <button className="px-5 py-3 rounded-lg bg-[#f9c63b] text-sm cursor-pointer">
            Book a call
          </button>
        </div>
      </div>
