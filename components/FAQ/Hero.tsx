    ...
    <div>
      ...
      <div className="flex flex-col max-w-[1200px] mx-auto pt-30 bg-[#FAF5F2]">
        <div className="flex md:flex-row flex-col space-y-5 items-center justify-between md:px-0 px-5">
          <div className="text-6xl tracking-tighter leading-tight font-horizona">

            Welcome to <br /> Hashmint Support!
          </div>
          <p className="text-md justify-center text-[#4B4C47] tracking-tighter leading-tight">
            Thanks for contacting Hashmint Support! We're here to help. <br /> Start by browsing our FAQs for quick solutions—if your question <br /> isn’t covered,  feel free to reach out to our team by email or text
          </p>
        </div>
          ...
          {contents.map((item, index) => {
            return (
              <div
                ...
                key={index}
              >
                <div className="text-lg sm:text-xl md:text-2xl text-center mb-5 tracking-tighter leading-tight font-horizona">
                  {item.name}
                </div>
                <Image
                  src={item.image}
        ...
        <div className="mt-10 mb-20">
          ...
          <div className="flex md:flex-row flex-col justify-between space-y-5  md:items-start items-center md:mt-10 md:mb-10 ">
            <div className="text-2xl md:w-[700px] w-full md:px-0 px-4 md:text-start text-center tracking-tighter leading-tight font-horizona ">
            ...
            <div className="flex flex-col  md:text-start text-center justify-center tracking-tighter leading-tight ">
              <p className="text-base text-[#535450] font-regular">Feel free to contact us:</p>
              <p className="text-base text-[#535450] font-regular">Email: <span className='underline'>jimmy@hashmint.tech               </span></p>
              <p className="text-base text-[#535450] font-regular">Text: <span className='underline'>+91 98715 47671</span></p>
