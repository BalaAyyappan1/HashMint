...
const Footer = () => {
  ...
  const Logos = [
    { name: 'Twitter', src: "/Footer/twitter.svg" },
    ...
    <footer className="flex flex-col w-full h-[120vh] bg-[#000000]  text-white">
      ...
      <div className="relative w-full">
        ...
        <div className="absolute top-100 left-40 ">
          <button className="px-50 py-4 text-[30px] rounded-xl bg-[#f9c63b] hover:bg-[#f9c63bf2] cursor-pointer">
            Book a call
          </button>
      ...
      <div className="flex flex-row justify-center space-x-60 items-center w-full mx-auto max-w-9xl px-10 ">
        <div className="flex flex-col space-y-50 items-center">
          <Link href='/ ' className="flex flex-row items-center space-x-10">
            <Image
              src={HashmintLogo}
              alt="logo"
              width={100}
              height={100}
              className="w-[20%] h-[50%] bg-white rounded-2xl"
            />
        ...
        <div className="flex flex-col space-y-50 mt-10 justify-center">
            ...
            <div className="flex flex-col">
              ...
              {NavContents.map((item, index) => (
                <Link
                  key={index}
                  href={item.link}
                  className="text-[19px] font-semibold hover:underline cursor-pointer"
                >
                  {item.name}
                </Link>
              ))}
          ...
          <div className="w-full">
            ...
            <div className="relative">
              ...
              />
              <button
                className="absolute top-1/2 right-2 -translate-y-1/2 px-4.5 py-2 bg-[#f9c63b] text-black rounded-xl text-sm whitespace-nowrap cursor-pointer hover:bg-[#f9c63bf2]"
              >
                Book a call
              </button>
            </div>
