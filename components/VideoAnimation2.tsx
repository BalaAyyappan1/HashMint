...
>
  <div className="w-full h-screen max-w-[1920px] mx-auto aspect-video flex justify-center items-center relative">
    ...
    >
      <source src="/457563_South Africa_Africa_3840x2160.mp4" type="video/mp4" />
